...
- [X] T016 [US1] Implement newest-first traversal in pages of at most 100 records with fixed 500-history-record and 200-unique-detail budgets, detail deduplication and concurrency of two, affirmative league-provenance gating before caller filters, completed/player-row validation, patch/date/tier filtering, post-filter count, partial-record handling, examined/hydrated coverage, and limit-specific truncation in src/open_dota_mcp/services/fantasy.py
